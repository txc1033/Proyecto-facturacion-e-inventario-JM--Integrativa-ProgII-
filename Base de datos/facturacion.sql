--
--- comando previos (administracion db{necesario para la conexion})
--
CREATE DATABASE facturacion;
CREATE USER 'javier'@'localhost' IDENTIFIED BY '1031';
GRANT ALL PRIVILEGES ON facturacion . * TO 'javier'@'localhost';
...
(1, 'Bota Larga', 100000, 80000, 20, 19, '00003-A', '2016-11-03'),
(2, 'Bota corta', 70000, 50000, 55, 19, '00003-A', '2016-10-11'),
(3, 'Botin ', 150000, 130000, 18, 19, '00003-A', '2016-09-01'),
(4, 'Tenis ', 120000, 100000, 8, 20, '00002-2', '2016-10-02'),
(5, 'Zandalias', 50000, 30000, 59, 21, '00001-1', '2016-11-01'),
(6, 'Jeans', 90000, 70000, 18, 24, '00004-4', '2016-10-02'),
(7, 'Camisas', 50000, 30000, 12, 22, '00003-A', '2016-10-20'),
(8, 'Chaquetas', 70000, 50000, 8, 24, '00004-4', '2016-11-02'),
(9, 'Chaquetas sudadera', 60000, 40000, 20, 23, '00002-2', '2016-10-23'),
(10, 'Pantalon sudadera', 60000, 40000, 17, 23, '00002-2', '2016-10-23'),
(11, 'Sudadera completa', 100000, 80000, 20, 23, '00002-2', '2016-10-23'),
(12, 'Camisetas', 30000, 20000, 30, 24, '00005-F', '2016-10-03');
...
('FACT-9910966', 3, 'pequeño', '28/11/2016', 1);
...
('FACT-9910966', '125', 'jose', '27/11/2013', 1, '437500', '70000');
